...
window.addEventListener("DOMContentLoaded", async () => {
    await audio.load("tick", "audio/119748__jesabat__clock-ticking.wav");
    await audio.load("alarm", "audio/696164__theprinter__alarm_sweep_04.wav");
});
function updateClock() {
      audio.play("tick", { volume: 0.3 });
  const now = new Date();
